...
public final class GameOverOverlay {
    ...
    public static void draw(SpriteBatch batch, ShapeRenderer shapes) {
        ...
        Assets.font.draw(batch, "Press SPACE to restart", Constants.BOARD_X + Constants.RESTART_PROMPT_X, Constants.BOARD_Y + Constants.BOARD_PX_H / 2f + Constants.TEXT_CENTER_Y_OFFSET_SMALL);
        batch.end();
    }
